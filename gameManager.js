...
game_Manager.prototype.check_player_collision = function( player1, player2 ) {

        //Left wall.
    while((player1.pos.x+8 > player2.pos.x-8) && (player1.pos.x+8 < player2.pos.x-6) ) {
        if ((player1.pos.y-8 < player2.pos.y+8) && (player1.pos.y+8 > player2.pos.y-8)) 
        {
            player1.pos.x = (player2.pos.x - 50);
        console.log('WORKED1');
    }
    break;
    }
    ...
    while((player1.pos.y+8 > player2.pos.y-8) && (player1.pos.y+8 < player2.pos.y-6) ) {
        if ((player1.pos.x-8 < player2.pos.x+8) && (player1.pos.x+8 > player2.pos.x-8)) {
            player1.pos.y = (player2.pos.y - 50);
        console.log('WORKED3');
    }
    break;
    }
    ...
    //if((player1.pos.x == player2.pos.x) /*&& ((player1.pos.y+5 == player2.pos.y-5) ||(player1.pos.y-5 == player2.pos.y+5))*/){
    //    player1.pos.x = (player2.pos.x + 50);
     //   console.log('WORKED');
    //}

        //Fixed point helps be more deterministic
    //player1.pos.x = player1.pos.x.fixed(4);
    //player1.pos.y = player1.pos.y.fixed(4);
    
}; //game_Manager.check_collision
game_Manager.prototype.check_player1_collision = function( item ) {
if((item.pos.x-5 == this.players.other.pos.x+5) /*&& ((item.pos.y == this.players.other.pos.y-5) ||(item.pos.y-5 == this.players.other.pos.y+5))*/) {
        item.pos.x = this.players.other.pos.x+6;
        console.log('WORKED');
    }


    if((item.pos.x+5 == this.players.other.pos.x-5) /*&& ((item.pos.y+5 == this.players.other.pos.y-5) ||(item.pos.y-5 == this.players.other.pos.y+5))*/){
        item.pos.x = this.players.other.pos.x-6;
        console.log('WORKED');
    }
};
        ...
        for(var j = 0; j < ic; ++j) {
            ...
            for(var i = 0; i < c; ++i) {
                ...
                if(key == "u") {
                    y_dir -= 1;
                    jumping = true;
                /*for(var speed = 10; speed > 0; speed--) {
                y_dir = -(speed);
                }*/
...
game_Manager.prototype.server_update_physics = function() {
    ...
    this.check_player1_collision( this.players.self );
    this.check_player_collision( this.players.self, this.players.other );
